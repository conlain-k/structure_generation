...
parser.add_argument(
    "--inp_dir", nargs=1, required=True, help="Where to write .inp files to"
)
parser.add_argument(
    "--micro_file", nargs=1, required=True, help="What microstructure file to read in"
)
parser.add_argument(
    "--contrast_ratio", nargs=1, required=True, help="What contrast ratio to write out"
)
parser.add_argument(
    "--voxel_size",
    nargs=1,
    required=True,
    help="What voxel width (i.e. k for a k x k x k microstructure) to write out",
)
